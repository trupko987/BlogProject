							...
							<div class="card">
								<div class="card-header">
									...
									<div class="card-tools">
										<a href="category-form.html" class="btn btn-success"> <i
									...
									<table class="table table-bordered">
										<thead>
											<tr>
												...
												<th class="text-center">Admin of this Category</th>
												<th class="text-center">Users for this Category</th>
										...
										<tbody>
											<c:forEach var="category" items="${categories}">
												<tr>
													...
													<td class="text-center">${numberOfBlogs}</td>
													<td>Admin of this Category</td>
													<td>Users for this Category</td>
													<td class="text-center">
														<div class="btn-group">
															<c:choose>
																<c:when test="${category.enabled}">
																	<a href="category-enabled?id=${category.id}"
