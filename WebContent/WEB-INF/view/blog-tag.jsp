        ...
        <main class="posts-listing col-lg-8"> 
          <div class="container">
            ...
            <div class="row">
              ...
              <c:forEach var="tag" items="${tagBlogs}">
              
              <div class="post col-xl-6">
                <div class="post-thumbnail"><a href="blog-post?id=${tag.id}"><img src="${pageContext.request.contextPath}/front/img/blog-post-1.jpeg" alt="" class="img-fluid"></a></div>
                <div class="post-details">
                  <div class="post-meta d-flex justify-content-between">
                    <div class="date meta-last">20 May | 2016</div>
                    <div class="category"><a href="#">${tag.category.name}</a></div>
                  </div><a href="blog-post?id=${tag.id}">
                    <h3 class="h4">${tag.title}</h3></a>
                  ...
                  <footer class="post-footer d-flex align-items-center"><a href="blog-author.html" class="author d-flex align-items-center flex-wrap">
                      ...
                      <div class="title"><span>${tag.author.name} ${tag.author.surname}</span></div></a>
