					...
					<div class="row">
						<div class="col-md-12">
							<div class="card card-primary">
								...
								<!-- form start -->
								<form:form role="form" action="slider-save" modelAttribute="slider">
									<form:hidden path="id" />
									<div class="card-body">
										<div class="row">
											<div class="col-md-6">
												...
												<div class="form-group">
													...
													<form:input type="text" class="form-control"
														placeholder="Enter slider title" path="title" />
												</div>
												
												<div class="form-group">
													<label>URL</label>
													<form:input type="text" class="form-control"
														placeholder="Enter url" path="url" />
												</div>
												
												<div class="form-group">
													<label>Button text</label>
													<form:input type="text" class="form-control"
														placeholder="Enter text on button" path="buttonTitle" />
												</div>
