							...
							<div class="card">
								<div class="card-header">
									...
									<div class="card-tools">
										<a href="author-form.html" class="btn btn-success"> <i
											class="fas fa-plus-square"></i> Add new User
										</a>
									</div>
								</div>
								<!-- /.card-header -->
									...
									<table class="table table-bordered">
										<thead>
											<tr>
												...
												<th class="text-center">e-mail adress</th>
											...
											<c:forEach var="author" items="${author}">
												<tr>
													...
													<td class="text-center"><c:choose>
															<c:when test="${author.enabled}">
																<a href="author-enabled?id=${author.id}"
													...
													<td><strong>${author.name} ${author.surname}</strong>
													</td>
													<td>${author.phoneNumber}
													<td>${author.email}</td>
													...
													<td class="text-center">
														<div class="btn-group">
															...
															<button type="button" class="btn btn-info"
																data-toggle="modal"
																data-target="#delete-modal-${author.id}"
																title="Delete user">
												...
												<div class="modal fade" id="delete-modal-${author.id}">
