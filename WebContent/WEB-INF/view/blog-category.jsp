          ...
          <div class="container">
            ...
            <div class="row">
              ...
              <div class="post col-xl-6">
                <div class="post-thumbnail"><a href="blog-post?id=${category.id}"><img src="${pageContext.request.contextPath}/front/img/blog-post-1.jpeg" alt="" class="img-fluid"></a></div>
                <div class="post-details">
                  <div class="post-meta d-flex justify-content-between">
                    <div class="date meta-last">${category.date}</div>
                    <div class="category"><a href="#">${category.category.name}</a></div>
                  </div><a href="blog-post?id=${category.id}">
                    <h3 class="h4">${category.title}</h3></a>
                  <p class="text-muted">${category.description}</p>
                  <footer class="post-footer d-flex align-items-center"><a href="blog-author?id=${category.author.id}" class="author d-flex align-items-center flex-wrap">
                      <div class="avatar"><img src="${pageContext.request.contextPath}/front/img/avatar-3.jpg" alt="..." class="img-fluid"></div>
                      <div class="title"><span>${category.author.name} ${category.author.surname}</span></div></a>
